...
export const fetchListCompanyCreations = async () => {
    if (!MyGlobalVar.listeCompanyCreations) {
        const response = await axios.get("http://localhost:9000/CompanyCreations");
...
export const addCompanyCreation = async (data) => {
    return await axios.post("http://localhost:9000/CompanyCreation/Create", data).then(response => {
        if (MyGlobalVar.listeCompanyCreations) {
...
export const deleteCompanyCreation = async (idActivity) => {
    return await axios.delete("http://localhost:9000/CompanyCreation/Delete/" + idActivity).then(response => {
